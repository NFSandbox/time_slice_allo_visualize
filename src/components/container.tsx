...
export function Container(
  ...
  // Container can't have a default color when selected
  if (selected) {
    hasColor = false;
  }
...
interface PageRootContainerProps {
  /**
   * An React Component stick at the top of the page as a header.
   */
  header: React.ReactNode;
  children: React.ReactNode;
  /**
   * Controls if the content part has paddings.
   */
  hasPadding?: boolean;
  /**
   * Add a space at the end of the content part
   */
  hasBottomSpace?: boolean;
  /**
   * Allow content part to scroll when overflow
   */
...
export function PageRootContainer(props: PageRootContainerProps) {
  let {
    hasPadding,
    allowScrolling,
    hasBottomSpace,
  ...
  allowScrolling = setDefault(allowScrolling, true);
  hasPadding = setDefault(hasPadding, true);
  hasBottomSpace = setDefault(hasBottomSpace, true);
  ...
  return (
    ...
    >
      ...
      <FlexDiv
        ...
        {props.children}
        {hasBottomSpace && <FlexDiv className={classNames(
          'flex-none h-[10rem]'
        )}></FlexDiv>}
      </FlexDiv>
    </FlexDiv>
